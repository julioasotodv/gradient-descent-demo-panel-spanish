...
dashboard = pn.Column(pn.pane.HTML(object="<h1>Demo Gradient Descent</h1>",
                      ...
                      pn.pane.HTML(object='<br><h3>Algoritmo</h3>',
                                   ...
                                   style={"margin-top": "0"}),
                      row_plot,
                      pn.pane.HTML(object="""<p>Demo por <a href="https://github.com/julioasotodv">Julio Antonio Soto</a>. Realizada con <a href="https://panel.holoviz.org/">Panel</a>, <a href="https://plotly.com/graphing-libraries/">Plotly</a>, 
